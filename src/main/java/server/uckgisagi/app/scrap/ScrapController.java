...
public class ScrapController {
    ...
    public ApiSuccessResponse<SuccessResponseResult> addScrap(@Valid @RequestBody ScrapRequest request, @ApiIgnore Long userId) {
    ...
    public ApiSuccessResponse<SuccessResponseResult> deleteScrap(@Valid @RequestBody ScrapRequest request, @ApiIgnore Long userId) {
